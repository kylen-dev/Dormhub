                        ...
                        <form action="{{ route('admin.add.store') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input name="first_name" class="form-control" value="{{ old('first_name') }}" pattern="[A-Za-z\s]+" title="Letters and spaces only"style="border-radius: 8px;" placeholder="Enter first name">
                                    @error('first_name') <small class="text-danger">{{ $message }}</small> @enderror
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Last Name</label>
                                    <input name="last_name" pattern="[A-Za-z\s]+" title="Letters and spaces only" class="form-control" value="{{ old('last_name') }}" style="border-radius: 8px;" placeholder="Enter last name">

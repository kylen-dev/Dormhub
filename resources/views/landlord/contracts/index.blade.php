...
<div class="landlord-container">
    ...
    <div class="landlord-container mb-4">
    <form method="GET" action="{{ route('landlord.contracts') }}" class="d-flex gap-3 flex-wrap">
        ...
        <select name="contract_status" class="form-select">
            ...
            <option value="terminated" {{ request('contract_status') == 'terminated' ? 'selected' : '' }}>
                Terminated
            </option>
        </select>

        <button type="submit" class="btn btn-primary">Filter</button>
        <a href="{{ route('landlord.contracts') }}" class="btn btn-secondary">Reset</a>
    </form>
</div>

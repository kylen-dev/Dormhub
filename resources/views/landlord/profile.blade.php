            ...
            <form method="POST" action="{{ route('landlord.profile.update') }}" enctype="multipart/form-data">
                ...
                <div class="row-inputs">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="contact_number" pattern="^09\d{9}$" 
           title="Enter a valid number (e.g., 09171234567)"class="form-control @error('contact_number') is-invalid @enderror"
                ...
                <div class="row-inputs">
                    <div class="form-group">
                        ...
                        <input type="text" name="first_name" pattern="[A-Za-z\s]+" title="Letters and spaces only" class="form-control @error('first_name') is-invalid @enderror"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="last_name" pattern="[A-Za-z\s]+" title="Letters and spaces only"class="form-control @error('last_name') is-invalid @enderror"
